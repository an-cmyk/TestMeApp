...
public class smokesanity1 {
	...
	public void online_Testmeapp_is_running() {
		System.setProperty("webdriver.chrome.driver","C:\\Anup\\chromedriver_win32 (2)\\chromedriver.exe");
		 driver =new ChromeDriver();
	}

	@When("user   does not provide  login credentials")
	public void user_does_not_provide_login_credentials() {
		driver.navigate().to("https://10.232.237.143/TestMeApp/fetchcat.htm");
	    driver.findElement(By.linkText("SignIn")).click();
	...
	public void user_gets_an_blank_error_message() {
		 System.out.println("Invalid Username and Password");
	}
